...
#define LCD_SPI_SPD_READ  5

/* SPI pins alternative function assign (0..15), (only hardware SPI) */
/* 5: Alternate SPI2 function for port B */
/* 6: Alternate SPI3 function for port C */
#define LCD_SPI_AFR       6
